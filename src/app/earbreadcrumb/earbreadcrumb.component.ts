...
@Component({
  selector: 'app-earbreadcrumb',
  templateUrl: './earbreadcrumb.component.html',
  styleUrls: ['./earbreadcrumb.component.css']
})
export class EarbreadcrumbComponent implements OnInit {
